...
- SuperMQ credentials (domain ID, channel ID, client IDs and keys) provisioned with `propeller-cli provision`. See the [Getting Started guide](/getting-started) for provisioning instructions.
