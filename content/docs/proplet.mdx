...
For how these map host files and volumes into WASM workloads — and how they behave with multiple concurrent tasks — see [Wasm HAL Directory & File Binding](/hal-directory-binding).
