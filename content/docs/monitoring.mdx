...
| Topic                                                       | Content                                                                                                         |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `m/{domain_id}/c/{channel_id}/control/proplet/task_metrics` | Per-task process metrics (CPU, memory, disk I/O, threads, file descriptors) — published while a task is running |
| `m/{domain_id}/c/{channel_id}/control/proplet/metrics`      | Proplet-level resource metrics (CPU, memory, cgroup stats) — published on a fixed interval                      |
