...
3. Metrics are published to MQTT topics:
   - Proplet-level: `m/{tenant_id}/c/{channel_id}/control/proplet/metrics`
   - Task-level: `m/{tenant_id}/c/{channel_id}/control/proplet/task_metrics`
...
**Subscribe to per-task metrics for a specific tenant/channel:**

```bash
mosquitto_sub -h localhost -p 1883 \
  -t "m/tenant_id-123/c/channel_id-456/control/proplet/task_metrics" -v
```
