...
The Proxy needs to connect to the same MQTT broker (Magistrala) as your Manager and Proplets:
...
| `PROXY_DOMAIN_ID`    | Your Magistrala domain ID                          | —                      | Yes      |
...
Get these values from your Magistrala setup. They should match what you used when provisioning the Propeller channel.
