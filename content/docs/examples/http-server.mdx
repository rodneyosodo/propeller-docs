...
The source code is available in the [examples/http-server](https://github.com/absmach/propeller/blob/main/examples/http-server/src/lib.rs) directory.

<CodeFromSource
  src="https://raw.githubusercontent.com/absmach/propeller/refs/heads/main/examples/http-server/src/lib.rs"
  lang="rust"
/>
...
For details, see [Proplet: Inbound HTTPS](/proplet#inbound-https).
