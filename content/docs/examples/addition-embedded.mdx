...
```
[00:00:05.123,000] <inf> mqtt_client: Message received on topic: m/<tenant_id>/c/<channel_id>/control/manager/start
...
[00:00:05.145,000] <inf> mqtt_client: Published to topic: m/<tenant_id>/c/<channel_id>/control/proplet/results. Payload: {"task_id":"b8fabc60-1156-4883-a2cd-4b70380ea5df","results":"30"}
