...
docker compose -f docker/compose.yaml down -v
[+] down 66/66
 ✔ Container magistrala-auth-redis                    Removed                                                                        2.0s
 ✔ Container magistrala-pdf                           Removed                                                                        1.8s
 ✔ Container magistrala-clients                       Removed                                                                        1.4s
 ✔ Container magistrala-jaeger                        Removed                                                                        1.7s
 ✔ Container magistrala-certs                         Removed                                                                        1.1s
 ✔ Container magistrala-clients-redis                 Removed                                                                        2.1s
 ✔ Container magistrala-seaweedfs-init                Removed                                                                        0.1s
 ✔ Container magistrala-channels                      Removed                                                                        0.7s
 ✔ Container magistrala-ui                            Removed                                                                        0.1s
 ✔ Container magistrala-notifications                 Removed                                                                        0.9s
 ✔ Container magistrala-groups                        Removed                                                                        1.6s
 ✔ Container magistrala-alarms                        Removed                                                                        1.2s
 ✔ Container magistrala-re                            Removed                                                                        0.7s
 ✔ Container magistrala-journal                       Removed                                                                        0.8s
 ✔ Container magistrala-domains-redis                 Removed                                                                        2.0s
 ✔ Container magistrala-ui-backend                    Removed                                                                        0.1s
 ✔ Container magistrala-reports                       Removed                                                                        1.1s
 ✔ Container magistrala-ui-backend-db                 Removed                                                                        2.2s
 ✔ Container magistrala-seaweedfs-s3                  Removed                                                                       10.6s
 ✔ Container magistrala-channels-db                   Removed                                                                        2.2s
 ✔ Container magistrala-channels-redis                Removed                                                                        1.7s
 ✔ Container magistrala-re-db                         Removed                                                                        1.7s
 ✔ Container magistrala-domains                       Removed                                                                        1.7s
 ✔ Container magistrala-journal-db                    Removed                                                                        2.5s
 ✔ Container magistrala-reports-db                    Removed                                                                        2.6s
 ✔ Container magistrala-certs-db                      Removed                                                                        2.8s
 ✔ Container magistrala-openbao                       Removed                                                                       10.5s
 ✔ Container magistrala-alarms-db                     Removed                                                                        2.7s
 ✔ Container magistrala-clients-db                    Removed                                                                        2.8s
 ✔ Container magistrala-users                         Removed                                                                        0.7s
 ✔ Container magistrala-groups-db                     Removed                                                                        2.5s
 ✔ Container magistrala-users-db                      Removed                                                                        2.5s
 ✔ Container magistrala-auth                          Removed                                                                        2.3s
 ✔ Container magistrala-domains-db                    Removed                                                                        2.1s
 ✔ Container magistrala-spicedb                       Removed                                                                        0.9s
 ✔ Container magistrala-auth-db                       Removed                                                                        0.9s
 ✔ Container magistrala-nginx                         Removed                                                                       11.0s
 ✔ Container magistrala-spicedb-migrate               Removed                                                                        0.0s
 ✔ Container magistrala-spicedb-db                    Removed                                                                        0.7s
 ✔ Container magistrala-fluxmq-node2                  Removed                                                                        2.8s
 ✔ Container magistrala-fluxmq-node3                  Removed                                                                        2.9s
 ✔ Container magistrala-fluxmq-node1                  Removed                                                                       10.6s
 ✔ Container magistrala-fluxmq-auth                   Removed                                                                        0.3s
 ✔ Volume magistrala_magistrala-auth-db-volume        Removed                                                                        0.1s
 ✔ Network magistrala-base-net                        Removed                                                                        0.3s
 ✔ Volume magistrala_magistrala-ui-backend-db-volume  Removed                                                                        0.9s
 ✔ Volume magistrala_magistrala-auth-redis-volume     Removed                                                                        0.1s
 ✔ Volume magistrala_magistrala-openbao-data          Removed                                                                        0.9s
 ✔ Volume magistrala_magistrala-users-db-volume       Removed                                                                        0.6s
 ✔ Volume magistrala_magistrala-spicedb-db-volume     Removed                                                                        0.8s
 ✔ Volume magistrala_magistrala-re-db-volume          Removed                                                                        0.1s
 ✔ Volume magistrala_magistrala-alarms-db-volume      Removed                                                                        0.3s
 ✔ Volume magistrala_magistrala-channels-db-volume    Removed                                                                        0.2s
 ✔ Volume magistrala_magistrala-domains-redis-volume  Removed                                                                        0.9s
 ✔ Volume magistrala_magistrala-clients-db-volume     Removed                                                                        0.3s
 ✔ Volume magistrala_magistrala-channels-redis-volume Removed                                                                        0.9s
 ✔ Volume magistrala_magistrala-reports-db-volume     Removed                                                                        1.0s
 ✔ Volume magistrala_magistrala-clients-redis-volume  Removed                                                                        0.4s
 ✔ Volume magistrala_magistrala-pat-db-volume         Removed                                                                        0.9s
 ... 7 more
```
...
Start the Magistrala backend services required for authentication, authorization, and MQTT messaging:
...
Propeller components (manager, proplet, proxy) communicate over MQTT and must authenticate with Magistrala. Provisioning creates the necessary identities and credentials:

- **User & Domain** — Authentication identity in Magistrala
...
1. Creates a Magistrala user and domain for authentication
...
```bash
docker ps --format "table {{.Names}}\t{{.Status}}" | grep -E "propeller|magistrala"
```
...
magistrala-clients                   Up 2 minutes
magistrala-channels                  Up 2 minutes
magistrala-users                     Up 2 minutes
magistrala-journal                   Up 2 minutes
magistrala-groups                    Up 2 minutes
magistrala-domains                   Up 2 minutes
magistrala-re                        Up 2 minutes
magistrala-reports                   Up 2 minutes
magistrala-auth                      Up 2 minutes
magistrala-notifications             Up 3 minutes
magistrala-alarms                    Up 2 minutes
magistrala-nginx                     Up 3 minutes
magistrala-certs                     Up 2 minutes
magistrala-spicedb                   Up 2 minutes
magistrala-fluxmq-node3              Up 3 minutes
magistrala-fluxmq-node2              Up 3 minutes
magistrala-fluxmq-node1              Up 3 minutes
magistrala-pdf                       Up 3 minutes
magistrala-groups-db                 Up 3 minutes
magistrala-alarms-db                 Up 3 minutes
magistrala-channels-db               Up 3 minutes
magistrala-certs-db                  Up 3 minutes
magistrala-domains-db                Up 3 minutes
magistrala-channels-redis            Up 3 minutes
magistrala-jaeger                    Up 3 minutes
magistrala-users-db                  Up 3 minutes
magistrala-seaweedfs-s3              Up 3 minutes
magistrala-domains-redis             Up 3 minutes
magistrala-auth-db                   Up 3 minutes
magistrala-clients-db                Up 3 minutes
magistrala-reports-db                Up 3 minutes
magistrala-auth-redis                Up 3 minutes
magistrala-openbao                   Up 3 minutes (healthy)
magistrala-re-db                     Up 3 minutes
magistrala-journal-db                Up 3 minutes
magistrala-ui-backend-db             Up 3 minutes (healthy)
magistrala-spicedb-db                Up 3 minutes
magistrala-fluxmq-auth               Up 3 minutes
magistrala-clients-redis             Up 3 minutes
```
